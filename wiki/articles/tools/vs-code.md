...
category: tools
type: tool
related: [GitHub, Claude Code, Codex, Node.js, Next.js, AI-Assisted Development]
tags: [code, editor, tools, development]
---

# VS Code

VS Code is [[Hendrix]]'s code editor. It is where [[Duodode]]'s technical work lives: front-end builds, [[Next.js]] projects, scripts, and everything touching the stack around [[Supabase]] and [[Vercel]].
...
VS Code is fast, familiar, and extensible. It does not get in the way. For a builder who values [[Build and Ship|moving quickly]] and [[Leverage|leverage]], the editor has to disappear. VS Code does.

## What it unlocks for him

- A single workspace for front-end, back-end, and automation work
- Clean integration with AI coding tools, which is central to how he builds
- Low switching cost across projects
- A stable base for the rest of his stack to sit on
