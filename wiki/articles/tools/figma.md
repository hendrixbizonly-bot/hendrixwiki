...
Figma is [[Hendrix]]'s primary design tool. It is where most of the visual work for [[Duodode]] lives: branding systems, interface design, product screens, and iteration on client work. For a designer building across [[Branding]] and [[Digital Product Work]], Figma is the default workbench.
...
Figma removes friction. No file versioning. No handoff pain. Real-time collaboration. That matches his [[Build and Ship|build and ship]] instinct: set up, move fast, ship. It is also native to how modern product teams work, which is where [[Duodode]] operates.
