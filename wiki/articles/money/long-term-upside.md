...
- Saying no to flashy but shallow opportunities
- Investing in skills ([[Self-Development]]) that pay off later
- Building [[Real Output]] instead of chasing trends
- Reading [[Serious Thinkers]] instead of feeds
- Running [[Duodode]] with patience instead of desperation
...
- [[Overthinking]] that paralyzes
- [[Perfectionism]] that delays
- [[Low-Value Activity]] that burns time
- Chasing visibility over value
- Trading long compounding for short gains

## Connection to philosophy

Long-term upside is [[Self-Development]] logic applied to the world. It is the [[Nietzsche|Nietzschean]] commitment to becoming across time, expressed in practical terms.
