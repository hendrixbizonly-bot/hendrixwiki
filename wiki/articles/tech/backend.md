...
category: tech
type: skill
related: [Supabase, Databases, Node.js, Next.js, API Testing, Automation Workflows]
tags: [backend, server, data, tools]
---
...
- [[Duodode]] apps that need real users and persistent data
- [[AI Automation]] workflows where backend glue is the actual product
- Internal tools for the agency
- Client builds that go beyond marketing sites

## What it unlocks

- Full-stack capability as a small operator
- Less dependency on other hands for simple backend work
- A clean loop from idea to shipped, working product
- Room to grow as [[Duodode]] scales

## Related

[[Supabase]] · [[Databases]] · [[Node.js]] · [[Next.js]] · [[API Testing]] · [[Automation Workflows]] · [[AI Automation]]
